...
export const config = { matcher: ["/admin/:path*", "/pipeline/:path*", "/intelligence/:path*", "/admin", "/pipeline", "/intelligence", "/engine/:path*", "/api/intake", "/api/intakes", "/api/audit", "/api/discover", "/api/pipeline-audits", "/api/intelligence"] };
